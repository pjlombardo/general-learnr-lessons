...
#### Exercise:
In the block below, write the additional code to add the point geometry to the plot.  Then, experiment with different variables for the `x` and `y` aesthetics.
