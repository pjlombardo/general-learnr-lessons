...
(*Note:* In science, titles are not used for plots.)
...
### Final Exercise
For the final exercise, I challenge you to *recreate* a plot using a new data frame and  what you have learned from this tutorial. Our data will come from the `mtcars` data frame, which collected information on a collection of cars featured in the 1974 *Motor Trend* magazine. 
...
* Making a blank canvas and ssociating a data frame with `ggplot(data= df)`
